<fieldset class="srtads">

<legend class="screen-reader-text"><span>Ad Tag Attributes</span></legend>
<label>
    <input type="checkbox"/>
    <span class="ad-tag-attribute">Responsive</span>
</label>
<br/>

<label>
    <input type="checkbox"/>
    <span class="ad-tag-attribute">Sticky</span>
</label>
<br/>

<label>
    <input type="checkbox"/>
    <span class="ad-tag-attribute">User-triggered refresh </span>
</label>
<label class="screen-reader-text" for="srtads_ad_tag_user_refresh_seconds">Minimal refresh interval</label>
<select id="srtads_ad_tag_user_refresh_seconds" class="ad-tag-attribute">
...
<label>
    <input type="checkbox"/>
    <span class="ad-tag-attribute">Event-triggered refresh </span>
</label>
<label class="screen-reader-text" for="srtads_ad_tag_event_refresh_seconds">Minimal refresh interval</label>
<select id="srtads_ad_tag_event_refresh_seconds" class="ad-tag-attribute">
    <option value="30">every 30 seconds</option>
...
<label>
    <input type="checkbox"/>
    <span class="ad-tag-attribute">Timer-based refresh </span>
</label>
<label class="screen-reader-text" for="srtads_ad_tag_time_refresh_seconds">Minimal refresh interval</label>
<select id="srtads_ad_tag_time_refresh_seconds" class="ad-tag-attribute">
    <option value="30">every 30 seconds</option>
    <option value="60">every 60 seconds</option>
